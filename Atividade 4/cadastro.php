            ...
            <form action="cadastro.php">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="password" class="form-control-plaintext border-bottom border-2 border-top-0 border-light border-opacity-50 w-100 fw-semibold text-light" autocomplete="off" placeholder="Repita a senha" required="true" id="imput-senha" name="repete-senha-cadastro">
                    </div>
    ...
    <!-- Linha 2 onde estão os elementos que constituem o formulário de login, são formatados pela classe "form" e "Jumbotron" -->
        ...
        <!-- A coluna está ocupando 4 espaços de um total de 12, com a classe flex-container ele fica formatada ao centro da página utilizando-se do flex-box do CSS-->
            <div class="col-lg-3 col-sm-10">
                <?php
                    $email=$_GET["email-cadastro"];
                    $senha=$_GET["senha-cadastro"];
                    $confirmaSenha=$_GET["repete-senha-cadastro"];
                ...
                <form class="g-3 jumbotron w-auto d-flex flex-column justify-content-between align-items-center" style="height: 30rem;" autocomplete="on" method="get" action="cadastro.php">
